...
//create functions to perform basic mathematics operations
...
function divide(num1, num2) {
    ...
    if(divideValue == 'Infinity') {
        return alert("Error! Cannot divide by 0! You should know better...");
...
function operate(operator, num1, num2) {
    switch (operator) {
        ...
        default:
            alert('ERROR! Didn\'t receive an operator or type as expected');
...
//calculator advanced feature and algo
...
function runCalculator() {
        ...
        operandButtons.forEach((button) => {
            button.addEventListener('click', () => {
                ...
                if(operator == "") {
                    ...
                    //append to num2 if multiple numbers and pressed and display out
    ...
    function getOperatorSelection() {
            ...
            operatorButtons.forEach((button) => {
                button.addEventListener('click', () => {
                    ...
                    if((tempNum1Array != "") && (tempNum2Array != "")) {
                        ...
                        console.log('clearing out the array and the nums now!');
                        tempNum1Array = [];
                        tempNum2Array = [];
                        num1 = 0;
                        num2 = 0;
                        ...
                        num1 = tempNum1Array.join('');
                        console.log('pushed string values to array 1: ', tempNum1Array);
                    }
                })
            })
        ...
        const signButton = document.querySelector('.sign');
            ...
            // append "+/-" button to numarray1 and display out
            if(operator == "") {
                const calcDisplay = document.querySelector('#display');
                ...
                // append "+/-" numarray2 and display out

                const calcDisplay = document.querySelector('#display');
                console.log('negative button registered here on num num2');
                tempNum2Array.splice(0, 1, (tempNum2Array[0] * -1).toString());
                console.log('append the array of negative number on num2: ', tempNum2Array);
                num2 = tempNum2Array.join('');
                calcDisplay.textContent = num2;
            }
            })
            ...
            const decimalButton = document.querySelector('.decimal');
                decimalButton.addEventListener('click', () => {
                    ...
                    if(operator == '') {
                        ...
                        // append "decimal" to numarray2 and display
                        const calcDisplay = document.querySelector('#display');
                        console.log('decimal button registered here!', decimalButton);
                        ...
                        calcDisplay.textContent = num2;
                        document.getElementById('decimal').disabled = true;
                        console.log('num2 decimal button should e disabled now');
                    }
